...
headerStr = 'model,learner,dim,mu,lambda,dataset,target,source,accuracy,precision,recall,f1,AUC';
fprintf(file,'%s\n',headerStr);
    ...
    for i = 1:length(fileList)
        ...
        for j = 1:length(fileList)
            ...
            if(i~=j)
                ...
                %parameter string
                resultStr = [modelName,',',learnerName,',',num2str(dim),',',num2str(mu),',',num2str(lambda),',',dataName,',',targetName,',',sourceName,',',num2str(accuracy),',',num2str(precision),',',num2str(recall),',',num2str(f_measure),',',num2str(AUC)]
                fprintf(file,'%s\n',resultStr);
            end
        end
    end
